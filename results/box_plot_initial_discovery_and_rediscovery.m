...
for j = 1:10
    ...
    file_discovery = sprintf(['DiscoveryTime_result_3way_50n_500us_Config%d_%d.txt'], configurations(i), j);
...
for j = 1:10
    %Enter the correct path and the file name
    file_rediscovery = sprintf(['RediscoveryTime_result_3way_50n_500us_Config%d_%d.txt'], configurations(i), j);
...
boxplot(data_rediscovery, 'positions', i+0.2, 'widths', 0.2, 'Notch', 'on', 'Color', rediscovery_color  )
