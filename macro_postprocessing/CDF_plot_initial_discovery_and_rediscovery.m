...
for c = 1:numel(configs)
    ...
    for i = 1:10
        ...
        file = sprintf('/scratch/DiscoveryTime_result_3way_50n_500us_Config%d_%d.txt',config, i);
   ...
   % Add code to plot rediscovery time
    ...
    for i = 1:10
        %Add the correct path to file
        rediscovery_file = sprintf('/scratch/RediscoveryTime_result_3way_50n_500us_Config%d_%d.txt',config, i);
