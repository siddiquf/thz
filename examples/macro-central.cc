...
int main (int argc, char* argv[])
  {
    ...
    int mcs, sectors;
    double  beamwidth, maxGain, radius, noiseFloor, carrierSenseTh, txPower, sinrTh, basicRate, dataRate, bandwidth, bit_energy,  centralFreq,noiseTotal;
